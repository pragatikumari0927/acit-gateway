...
All decisions respect the constraints in `CONTEXT.md`, `docs/PRD.md`, `AGENTS.md`, and `RULES.md`. No LLM participates in money-critical paths. Test-mode only.
...
See individual `docs/adr/00*.md` for the short historical forms of the first three records.
